...
const PageRegister = () => {
    return (
        <React.Fragment>
            <MetaTags>
                <title>Register | Trailox - React Admin & Dashboard Template</title>
            </MetaTags>
                                    ...
                                    <div className="d-flex flex-column h-100">
                                        <div className="mb-4 mb-md-5 text-center">
                                            <Link to="/dashboard" className="d-block auth-logo">
                                                <img src={logo} alt="" height="28" /> <span className="logo-txt">Trailox</span>
                                            </Link>
                                        </div>
                                        <div className="auth-content my-auto">
                                            <div className="text-center">
                                                <h5 className="mb-0">Register Account</h5>
                                                <p className="text-muted mt-2">Get your free Trailox account now.</p>
                                            </div>
                                            <form className="needs-validation custom-form mt-4 pt-2" novalidate action="index.html">
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0">By registering you agree to the Trailox <Link to="#" className="text-primary">Terms of Use</Link></p>
                                                </div>
                                                <div className="mb-3">
                                        ...
                                        <div className="mt-4 mt-md-5 text-center">
                                            <p className="mb-0">© <script>document.write(new Date().getFullYear())</script> Trailox   . Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
